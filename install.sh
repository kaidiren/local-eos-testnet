...
cleos system newaccount eosio eosio.a EOS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV EOS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV --stake-net "10.0000 EOS" --stake-cpu "10.0000 EOS" --buy-ram-kbytes "128 KiB"

cleos push action eosio.token transfer '{"from": "eosio", "to":"eosio.a","quantity":"1000000.0000 EOS","memo":"give"}' -p eosio

cleos system buyram eosio.a eosio "90000 EOS"
